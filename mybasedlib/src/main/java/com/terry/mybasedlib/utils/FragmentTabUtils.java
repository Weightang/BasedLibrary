...
public class FragmentTabUtils implements RadioGroup.OnCheckedChangeListener {
     ...
     */
    public FragmentTabUtils(FragmentManager fragmentManager, Fragment[] fragments, int fragmentContentId, RadioGroup rgs, OnRgsExtraCheckedChangedListener onRgsExtraCheckedChangedListener) {
